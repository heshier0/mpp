...
static BOOL start_audio_system()
{
    HI_S32 i, j, s32Ret;
    AI_CHN      AiChn = 0;
    AO_CHN      AoChn = 0;
...
BOOL board_mpp_init()
{
    ...
    {
        utils_print("start audio system error!\n");
        board_stop_video_system();
        SAMPLE_COMM_SYS_Exit();
        return FALSE;
    }
