...
HI_S32 SAMPLE_VIO_ViOnlineVpssOnlineRoute(HI_U32 u32VoIntfType)
{
    ...
    PIXEL_FORMAT_E     enPixFormat    = PIXEL_FORMAT_YUV_SEMIPLANAR_420;//PIXEL_FORMAT_YVU_SEMIPLANAR_420;
...
HI_S32 SAMPLE_VIO_ViWdrSwitch(HI_U32 u32VoIntfType)
{
	...
	if(g_sns_type[0] != SAMPLE_SNS_TYPE_BUTT )
		stViConfig.astViInfo[s32WorkSnsId].stSnsInfo.enSnsType = g_sns_type[0];
	else
...
HI_S32 SAMPLE_VIO_ResoSwitch(HI_U32 u32VoIntfType)
{
	...
	if(g_sns_type[0] != SAMPLE_SNS_TYPE_BUTT ){
		...
		if ((SONY_IMX458_MIPI_4M_60FPS_10BIT != g_sns_type[0])
    	    && (SONY_IMX458_MIPI_4M_40FPS_10BIT != g_sns_type[0])
    	    && (SONY_IMX458_MIPI_8M_30FPS_10BIT != g_sns_type[0])
    	    && (SONY_IMX458_MIPI_12M_20FPS_10BIT != g_sns_type[0])
    	    && (SONY_IMX458_MIPI_1M_129FPS_10BIT != g_sns_type[0]))
    	{
	...
	if(g_sns_type[0] != SAMPLE_SNS_TYPE_BUTT){
		if (SONY_IMX458_MIPI_1M_129FPS_10BIT == g_sns_type[0])
    	{
...
HI_S32 SAMPLE_VIO_VPSS_VO_MIPI_TX(HI_U32 u32VoIntfType, HI_U32 saturation, HI_U32 sns0_rotat, HI_U32 lcd_sel)
{
    HI_S32             s32Ret = HI_SUCCESS;
...
HI_S32 SAMPLE_VIO_VPSS_VO_MIPI_TX_DOUBLE_VI(HI_U32 u32VoIntfType, HI_U32 saturation, HI_U32 sns0_rotat, HI_U32 sns1_rotat, HI_U32 lcd_sel)
{
    HI_S32             s32Ret = HI_SUCCESS;
...
HI_S32 SAMPLE_VIO_VPSS_VO_HDMI(HI_U32 u32VoIntfType, HI_U32 saturation, HI_U32 sns0_rotat)
{
    HI_S32             s32Ret = HI_SUCCESS;
...
HI_S32 SAMPLE_VIO_VPSS_VO_HDMI_DOUBLE_VI(HI_U32 u32VoIntfType, HI_U32 saturation, HI_U32 sns0_rotat, HI_U32 sns1_rotat)
{
    HI_S32             s32Ret = HI_SUCCESS;
